...
//
//     final hyggeSongModel = hyggeSongModelFromJson(jsonString);

import 'dart:convert';

HyggeSongModel hyggeSongModelFromJson(String str) =>
    HyggeSongModel.fromJson(json.decode(str));

String hyggeSongModelToJson(HyggeSongModel data) => json.encode(data.toJson());
...
class HyggeSongModel {
  ...
  factory HyggeSongModel.fromJson(Map<String, dynamic> json) => HyggeSongModel(
        id: json["id"],
